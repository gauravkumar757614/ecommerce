<div class="tab-pane fade" id="banner-three" role="tabpanel" aria-labelledby="banner-three-list">
        ...
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-three') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form group">
                    ...
                    <label class="custom-switch mt-2">
                        <input type="checkbox" name="banner_one_status" class="custom-switch-input"
                            {{ @$banner_three_content['banner_one']['banner_status'] == 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset(@$banner_three_content['banner_one']['banner_image']) }}" alt="banner one"
                        width="150px">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_one_old_image"
                        value="{{ @$banner_three_content['banner_one']['banner_image'] }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_one_url"
                        value="{{ @$banner_three_content['banner_one']['banner_url'] }}">
                </div>
                ...
                <div class="form group">
                    ...
                    <label class="custom-switch mt-2">
                        <input type="checkbox" name="banner_two_status" class="custom-switch-input"
                            {{ @$banner_three_content['banner_two']['banner_status'] == 1 ? 'checked' : '' }}>
                        <span class="custom-switch-indicator"></span>
                    </label>
                </div>
                ...
                <div class="form-group">
                    <label for="">Preview</label><br>
                    <img src="{{ asset(@$banner_three_content['banner_two']['banner_image']) }}" alt="banner one"
                        width="150px">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_two_old_image"
                        value="{{ @$banner_three_content['banner_two']['banner_image'] }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_two_url"
                        value="{{ @$banner_three_content['banner_two']['banner_url'] }}">
                </div>
                ...
                <div class="form group">
                    ...
                    <label class="custom-switch mt-2">
                        <input type="checkbox" name="banner_three_status" class="custom-switch-input"
                            {{ @$banner_three_content['banner_three']['banner_status'] == 1 ? 'checked' : '' }}>
                        <span class="custom-switch-indicator"></span>
                    </label>
                </div>
                ...
                <div class="form-group">
                    <label for="">Preview</label><br>
                    <img src="{{ asset(@$banner_three_content['banner_three']['banner_image']) }}" alt="banner one"
                        width="150px">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_three_old_image"
                        value="{{ @$banner_three_content['banner_three']['banner_image'] }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_three_url"
                        value="{{ @$banner_three_content['banner_three']['banner_url'] }}">
                </div>
