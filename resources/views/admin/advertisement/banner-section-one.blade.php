<div class="tab-pane fade show active" id="banner-one" role="tabpanel" aria-labelledby="banner-one-list">
        ...
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-one') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form group">
                    ...
                    <label class="custom-switch mt-2">
                        <input type="checkbox" name="status" class="custom-switch-input"
                            {{ @$banner_one_content['banner_one']['status'] == 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset(@$banner_one_content['banner_one']['banner_image']) }}" alt="banner one"
                        width="150px">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_old_image"
                        value="{{ @$banner_one_content['banner_one']['banner_image'] }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_url"
                        value="{{ @$banner_one_content['banner_one']['banner_url'] }}">
                </div>
