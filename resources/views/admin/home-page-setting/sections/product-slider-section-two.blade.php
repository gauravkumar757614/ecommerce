@php
    $productSliderTwo = json_decode($productSliderSectionTwo->value, true);
    // @dd($productSliderTwo);
@endphp
<div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.product-slider-section-two.update') }}" method="POST">
                @csrf
                @method('PUT')
