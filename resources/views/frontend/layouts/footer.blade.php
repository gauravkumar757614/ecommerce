...
<footer class="footer_2">
    <div class="container">
        <div class="row justify-content-between">
                ...
                <div class="wsus__footer_content">
                    ...
                    <ul class="wsus__footer_menu">
                        @foreach ($footerLinks as $link)
                            <li>
                                <a href="{{ $link->url }}"><i class="fas fa-caret-right"></i> {{ $link->name }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="col-xl-2 col-sm-5 col-md-4 col-lg-2">
                <div class="wsus__footer_content">
                    <h5>{{ $footerThreeTitle->footer_grid_three_title }}</h5>
                    <ul class="wsus__footer_menu">
                        @foreach ($footerThreeLinks as $threeLink)
                            <li><a href="{{ $threeLink->url }}"><i
                                        class="fas fa-caret-right"></i>{{ $threeLink->name }}</a></li>
                        @endforeach
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    ...
                    <form accept="" method="POST" id="newsletter">
                        @csrf
                        <input type="text" name="email" placeholder="Email..." class="newsletter_email">
