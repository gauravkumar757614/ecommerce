...
@section('content')
                        ...
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            @foreach ($shippingMethods as $method)
                                ...
                                @elseif ($method->type == 'flat_cost')
                                    <div class="form-check">
                                        <input class="form-check-input shipping_method" type="radio" name="exampleRadios"
                                            id="exampleRadios2" value="{{ $method->id }}" data-id="{{ $method->cost }}">
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                <p>coupon (-): <span> {{ $settings->currency_icon }} {{ getCouponDiscount() }} </span>
                                </p>

                                <p><b>total:</b> <span><b id="total_amount" data-id="{{ getTotalPayable() }}">
    ...
    {{-- Pop modal to add a new address --}}
        ...
        $(document).ready(function() {
            ...
            $('#submitCheckoutForm').on('click', function(e) {
                ...
                if ($('#shipping_method_id').val() == "") {
                    ...
                    toastr.error('Please check agree to term and condition');
                } else {
                    $.ajax({
