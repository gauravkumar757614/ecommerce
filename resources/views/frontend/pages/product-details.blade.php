                        ...
                        <div class="wsus__pro_details_text">
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    ...
                                    <li>
                                        <a style="border: 1px solid gray; padding: 7px 11px; border-radius:100%"
                                            href="javascript:;" class="add_to_wishlist" data-id="{{ $product->id }}">
                                    ...
                                    <li>
                                        <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                            ...
                                            style="border: 1px solid gray; padding: 11px 11px; border-radius:100%; margin-left:7px">
        ...
        $(document).ready(function() {
            $('.message_modal').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        let html = `<span class="spinner-border spinner-border-sm" aria-hidden="true">
                                    </span>
                                    <span role="status">
                                        Sending...
                                    </span>`
