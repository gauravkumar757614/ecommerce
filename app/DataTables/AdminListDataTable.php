    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                // Disabling status and delete button if the admin is super role
                if ($query->id !== 1) {
                    // Delete button
                    $deleteBtn     =   "<a href='" . route('admin.admin-list.destroy', $query->id) . "' class='btn btn-danger ml-2 delete-item'>
